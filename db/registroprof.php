...
$nombrefinal = trim ($_FILES['cdProf']['name']);
$carpeta_destino=$_SERVER['DOCUMENT_ROOT'].'/BI1/uploads/';

if(move_uploaded_file($_FILES['cdProf']['tmp_name'], $carpeta_destino)){

	$insertar = "INSERT INTO info_profesionista VALUES ('$usuario', '$clave', '$nombre', '$apellidos', '$correo', '$fechanac', '', '$ciudad', '$curp', DEFAULT, '$curriculum', '$nombrefinal', '$rfc')";
